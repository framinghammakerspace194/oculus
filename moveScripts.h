...
void moveBlink(){
  ...
  int backTestServoPos = lastTestServoPos;

  moveEyesAdv(lastXPos, lastYPos, 0, 0, 0, 0, lastTestServoPos);
  delay(150);
  moveEyesAdv(lastXPos, lastYPos, backOpenL, backOpenR, backOffsetL, backOffsetR, backTestServoPos);
...
void moveTwitch(){
  for(int i = 0; i < random(1,4); i++){
    moveEyes(
      ...
      constrain(lastTestServoPos + random(-150, 150), -1000, 1000));
    delay(random(50, 200));
  }
...
void moveRandom(){
  linearMove(random(-900, 900), random(-800, 650), random(100, 600), random(-300, 300), random(100, 800), random(-900, 900));
  delay(random(200, 1000));
}

void moveRandomMiddle(){
  linearMove(random(-700, 700), random(-300, 300), random(100, 600), random(-300, 300), random(100, 600), random(-700, 700));
  delay(random(200, 1000));
}
